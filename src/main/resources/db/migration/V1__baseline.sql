-- =====================================================================
-- MemoSpark — Flyway Baseline Migration V1
-- All tables required by JPA entities in com.memospark.core.domain.*
-- Idempotent: guarded by IF NOT EXISTS clauses.
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS `review_logs` (
  ...
  KEY `idx_review_logs_user_date` (`card_id`, `review_date`),
...
CREATE TABLE IF NOT EXISTS `code_problems` (
  ...
  KEY `idx_code_problems_difficulty` (`difficulty`),
  KEY `idx_code_problems_category` (`category`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `code_submissions` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_code_submissions_problem_user` (`problem_id`, `user_id`),
...
CREATE TABLE IF NOT EXISTS `problem_notes` (
  ...
  KEY `idx_problem_notes_user_next_retry` (`user_id`, `next_retry_date`),
